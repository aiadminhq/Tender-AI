...
- **Layer B**（收藏、評分、想法、行為）在使用**公司帳號**且**已取得本人同意**的前提下，
  會被**量化成向量、進入大家共享的知識庫**。
- 共享對象 ＝ **惠強（HQ Design）本人 ＋ 惠強同事 ＋ 專案 AI/agent**（合作範圍內）。
  在合作範圍內**看得到彼此的貢獻、可互相學習、可標示貢獻者**。
- **紅線**：對「**非合作範圍的對象**」（外部／未授權第三方）**永不揭露、永不外流**；
  對外發佈或匯出一律**去識別化**。
...
| Layer B | 同事的行為與想法 | **合作範圍內共享、對外永不揭露**（需同意＋公司帳號） |

  ...
  return (
    <div className="flex flex-col space-y-5">
      ...
      <AssistantRuntime scope="assistant_page" focusTenderId={tenderId}>
        <div className="grid h-[calc(100svh-13rem)] min-h-[460px] grid-cols-1 overflow-hidden rounded-lg border border-border bg-white lg:grid-cols-[minmax(0,1.45fr)_minmax(340px,1fr)]">

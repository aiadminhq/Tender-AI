          ...
          <div className="space-y-2">
            <div className="flex items-end gap-2">
              <textarea
                ...
                className="max-h-32 min-h-[40px] flex-1 resize-none rounded-md border border-border bg-canvas px-3 py-2 text-[13px] text-foreground outline-none transition-colors placeholder:text-ink-dim focus:border-ring focus:ring-2 focus:ring-ring/50"
              />
              <Button
                size="icon"

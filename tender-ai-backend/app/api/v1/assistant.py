...
async def chat(
    ...
    owner_user_id, actor = await _assistant_identity(session, authorization)
    return StreamingResponse(
        stream_chat_events(session, payload, owner_user_id=owner_user_id, actor_user=actor),
...
async def list_threads(
    ...
    owner_user_id, _ = await _assistant_identity(session, authorization)
